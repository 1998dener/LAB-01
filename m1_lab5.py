...
print()  
print("Segue a lista dos partidos encontrados na página: ")
print()    
...
print()      
print('O partido',nome_partido,'obteve um total de',num_vereadores,'vereadores') 
print("Partido mais votado!") 
